...
def remove_variaveis(str1):
    ...
    #print("1. REMOÇÃO DE VARIÁVEIS - Função remove_variaveis()")
    ...
    #print("1. Tempo de remoção das variáveis foi de ","%s segundos" % (time.time() - remocaotime))
...
def inipro_pab(n):
    ...
    #print("8. Processo de adequação de bases levou ","%s segundos" % (time.time() - iniciopab))
...
# 3. Salve a base resultante como output

anomes = str(inicio)[0:6]
string_save = "emails_classificados_" + anomes + ".csv"
basefull.to_csv(string_save)
